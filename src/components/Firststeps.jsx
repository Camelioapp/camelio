    ...
    () => [
      {
        ...
        subtitle: "Cette étape nous aide à adapter Camelio à votre réalité familiale.",
      },
      {
        title: "Vos enfants",
        subtitle: "Ajoutez les enfants pour lesquels vous souhaitez organiser votre espace Camelio.",
      },
      {
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-900/40 px-4 py-6 backdrop-blur-sm">
      <div className="w-full max-w-3xl overflow-hidden rounded-[2rem] bg-white shadow-2xl">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-[#a8b193] focus:ring-4 focus:ring-[#a8b193]/15"
                />
              </div>
        ...
        <div className="flex flex-col-reverse gap-3 border-t border-slate-100 bg-white px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          >
            {step === steps.length - 1 ? "Terminer sans compléter" : "Sauter cette étape"}
          </button>
