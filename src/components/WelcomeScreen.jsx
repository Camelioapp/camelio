    ...
    >
      ...
      <div className="mx-auto flex h-full w-full max-w-[430px] flex-col overflow-hidden rounded-[2rem] bg-[#FFFCF7] px-5 py-5 shadow-2xl ring-4 ring-white/60 sm:rounded-[2.5rem] sm:px-6 sm:py-6">
        ...
        <button
          type="button"
          onClick={handleLogin}
          className="mt-4 w-full shrink-0 rounded-2xl bg-[#8FA173] px-5 py-3.5 text-[1rem] font-bold tracking-wide text-white shadow-sm transition hover:brightness-95 sm:mt-5 sm:rounded-3xl sm:py-4 sm:text-[1.12rem]"
        >
          Connexion
        </button>
      </div>
